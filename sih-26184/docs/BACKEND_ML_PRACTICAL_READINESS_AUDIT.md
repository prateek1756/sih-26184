...
- **Prototype In-Memory State Layer:** `LiveIngestionService` maintains the active 30-day ring buffer in process memory for sub-millisecond ranking performance.
