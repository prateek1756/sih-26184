# HERMES AI — Environment Setup & Execution Guide
...
DATABASE_URL=postgresql+asyncpg://hermes_user:hermes_password@localhost:5500/sih_26184
SYNC_DATABASE_URL=postgresql://hermes_user:hermes_password@localhost:5500/sih_26184
